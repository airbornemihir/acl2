...
(L1-FS-P-ASSOC (481 481 (:REWRITE DEFAULT-CAR))
               (247 247 (:REWRITE DEFAULT-CDR)))
(L1-STAT (1001 1001 (:REWRITE DEFAULT-CAR))
         (131 46 (:REWRITE L1-FS-P-ASSOC))
         (5 1 (:DEFINITION EQLABLE-ALISTP)))
(L1-STAT-OF-L1-STAT-LEMMA-1 (487 487 (:REWRITE DEFAULT-CAR))
                            (258 258 (:REWRITE DEFAULT-CDR))
                            (72 27 (:REWRITE L1-FS-P-ASSOC)))
