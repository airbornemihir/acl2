...
(REMOVE-N (16 16
          ...
          (1 1 (:REWRITE DEFAULT-+-1)))
(REPLACE-VAR)
(SUBSTRING (380 76 (:DEFINITION LEN))
           (377 200 (:REWRITE DEFAULT-+-2))
           (246 200 (:REWRITE DEFAULT-+-1))
           (200 8 (:REWRITE O<=-O-FINP-DEF))
           (156 6 (:DEFINITION TAKE))
           (115 88 (:REWRITE DEFAULT-CDR))
           (105 42 (:REWRITE DEFAULT-<-1))
...
(WRITE-LIST-STMT)
(WRITE-FROM-BINDINGS)
(WRITE-LIST-MSTEPS (1 1 (:TYPE-PRESCRIPTION TRUE-LISTP)))
(WRITE-FROM-PTRS)
(WRITEL)
(EVAL-SYMBOL)
(FIND-READ-PHI)
...
(ALL-WRITE)
(NO-CONFLICT)
(COMBINE-BLOCKS (38 24 (:TYPE-PRESCRIPTION BINARY-APPEND)))
(COMBINE-ITERS (67 2 (:DEFINITION ACL2-COUNT))
