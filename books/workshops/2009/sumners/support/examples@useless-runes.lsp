...
(BPOS)
(BPOS-OF-BV)
(BDD-IF-LIFT-TEST (3 3 (:TYPE-PRESCRIPTION FAK)))
(BDD-REORDER-THEN (3 3 (:TYPE-PRESCRIPTION FAK)))
(BDD-REORDER-THEN2 (3 3 (:TYPE-PRESCRIPTION FAK)))
(BDD-REORDER-ELSE (3 3 (:TYPE-PRESCRIPTION FAK)))
(BDD-REORDER-ELSE2 (3 3 (:TYPE-PRESCRIPTION FAK)))
(BDD-REDUCE-THEN (3 3 (:TYPE-PRESCRIPTION FAK)))
(BDD-REDUCE-ELSE (3 3 (:TYPE-PRESCRIPTION FAK)))
(BDD-REDUCE-THEN2 (6 3 (:TYPE-PRESCRIPTION FAK)))
(BDD-REDUCE-ELSE2 (3 3 (:TYPE-PRESCRIPTION FAK)))
(BV-EQUAL-T-REDUCE)
(BV-EQUAL-NIL-REDUCE)
(BV-IF-T-NIL-REDUCE)
(REPLACE-VAR)
...
(BINARY-*-IF-LIFT-Y)
(UNARY-/-IF-LIFT-X)
(IF-IF-LIFT (3 3 (:TYPE-PRESCRIPTION FAK)))
(IF-SAME-THEN-ELSE (3 3 (:TYPE-PRESCRIPTION FAK)))
(PRV (1 1 (:TYPE-PRESCRIPTION PRV)))
(PRV2 (1 1 (:TYPE-PRESCRIPTION PRV2)))
(PRV3 (1 1 (:TYPE-PRESCRIPTION PRV3)))
(PRV-EVAPORATES (3 3 (:TYPE-PRESCRIPTION PRV)))
(PRV-FORCE-CASE-SPLIT (6 3 (:TYPE-PRESCRIPTION PRV2))
                      (3 3 (:TYPE-PRESCRIPTION PRV3))
                      (3 3 (:TYPE-PRESCRIPTION PRV)))
(PRV2-THEN-FAIL-DROP (3 3 (:TYPE-PRESCRIPTION PRV2)))
(PRV2-THEN-PASS-SHIFT (3 3 (:TYPE-PRESCRIPTION PRV2))
                      (3 3 (:TYPE-PRESCRIPTION PRV)))
(PRV2-IF-GEN-PRV (12 6 (:TYPE-PRESCRIPTION PRV2))
                 (3 3 (:TYPE-PRESCRIPTION PRV3))
                 (3 3 (:TYPE-PRESCRIPTION PRV)))
(PRV3-DROP-IF-T)
(GEN-TYPE-RULE)
...
(>=0-OF-LEN)
(>=0-OF-ACL2-COUNT)
(EQUAL-CONS-REDUX-1 (2 2 (:REWRITE DEFAULT-CDR))
                    (2 2 (:REWRITE DEFAULT-CAR)))
(EQUAL-CONS-REDUX-2 (2 2 (:REWRITE DEFAULT-CDR))
                    (2 2 (:REWRITE DEFAULT-CAR)))
(C-A)
(C-H)
(C-A-T-1 (9 9 (:TYPE-PRESCRIPTION C-A)))
(C-A-T-2 (22 22 (:TYPE-PRESCRIPTION C-A)))
(C-A-NIL (3 3 (:TYPE-PRESCRIPTION C-A)))
(GFL (1 1 (:TYPE-PRESCRIPTION GFL)))
(RFL)
(REPORT-CW-FALSE)
(REPORT-CW-TRUE)
(REPORT-FAIL-START)
(REPORT-FAIL-END)
(RFL-LEAF-CASE (3 3 (:TYPE-PRESCRIPTION RFL)))
(RFL-IF-TBR-CASE (6 6 (:TYPE-PRESCRIPTION RFL)))
(RFL-IF-FBR-CASE (6 6 (:TYPE-PRESCRIPTION RFL)))
(GFL-CREATES-RFL (6 3 (:TYPE-PRESCRIPTION FAIL))
                 (3 3 (:TYPE-PRESCRIPTION RFL))
                 (3 3 (:TYPE-PRESCRIPTION GFL)))
(GFL-REDUCE-T)
(PSEUDO-TERM-UNIQ-BINDP)
(PARSE-LETTHM (41 41 (:TYPE-PRESCRIPTION LAST)))
(BINDS-VARS1 (6 6 (:TYPE-PRESCRIPTION UNION-EQUAL)))
(BINDS-VARS)
(BINDS-FNS)
(LETTHM-FNS)
(LETTHM-BODY)
...
(<<-TRANSITIVE)
(<<-ASYMMETRIC)
(<<-TRICHOTOMY (7 2 (:REWRITE <<-ASYMMETRIC))
               (5 5 (:REWRITE LEXORDER-TRANSITIVE))
               (3 3 (:REWRITE <<-TRANSITIVE)))
(<<-IMPLIES-LEXORDER)
(RCDP)
(IFRP (75 23 (:REWRITE DEFAULT-+-2))
...
(ACL2->RCD (1 1 (:TYPE-PRESCRIPTION ACL2->RCD)))
(RCD->ACL2)
(G-AUX (102 28 (:REWRITE DEFAULT-+-2))
...
(G (1 1 (:TYPE-PRESCRIPTION ACL2->RCD)))
(S-AUX (102 28 (:REWRITE DEFAULT-+-2))
       (56 28 (:REWRITE DEFAULT-+-1))
       (36 6 (:REWRITE COMMUTATIVITY-OF-+))
       (30 6 (:DEFINITION INTEGER-ABS))
       (27 3 (:DEFINITION LENGTH))
       ...
       (3 3 (:REWRITE DEFAULT-COERCE-2))
       (3 3 (:REWRITE DEFAULT-COERCE-1)))
(S (1 1 (:TYPE-PRESCRIPTION ACL2->RCD)))
(RCDP-IMPLIES-TRUE-LISTP (38 10 (:REWRITE <<-TRICHOTOMY))
...
(ACL2->RCD-RCD->ACL2-OF-RCDP (190 50 (:REWRITE <<-TRICHOTOMY))
...
(ACL2->RCD-RETURNS-RCDP (76 20 (:REWRITE <<-TRICHOTOMY))
...
(ACL2->RCD-PRESERVES-EQUALITY (57 15 (:REWRITE <<-TRICHOTOMY))
...
(RCD->ACL2-ACL2->RCD-INVERSE (95 25 (:REWRITE <<-TRICHOTOMY))
...
(RCD->ACL2-OF-RECORD-NON-NIL (45 1 (:DEFINITION IFRP))
...
(G-OVER-IF)
(S-OVER-IF)
(G-SAME-S- (89 2 (:DEFINITION S-AUX))
...
(G-DIFF-S- (178 5 (:REWRITE G-AUX-IS-NIL-FOR-<<))
           ...
           (1 1
              (:REWRITE S-AUX-NON-NIL-CANNOT-BE-NIL)))
(G-OF-S-REDUX (429 10 (:REWRITE G-AUX-IS-NIL-FOR-<<))
...
(G-DIFF-S (178 5 (:REWRITE G-AUX-IS-NIL-FOR-<<))
          ...
          (1 1
             (:REWRITE S-AUX-NON-NIL-CANNOT-BE-NIL)))
(S-SAME-G (79 1 (:DEFINITION G-AUX))
...
(S-SAME-S (120 3 (:DEFINITION S-AUX))
...
(S-DIFF-S (228 5 (:DEFINITION S-AUX))
...
(S-NON-NIL-CANNOT-BE-NIL (78 2 (:DEFINITION S-AUX))
                         ...
                         (4 4 (:REWRITE DEFAULT-CDR)))
(NON-NIL-IF-G-NON-NIL (13 1 (:REWRITE G-AUX-IS-NIL-FOR-<<))
                      (8 2 (:REWRITE <<-TRICHOTOMY))
                      (2 2 (:REWRITE <<-TRANSITIVE))
                      (2 1 (:REWRITE <<-ASYMMETRIC))
                      (1 1 (:TYPE-PRESCRIPTION RCDP)))
(UPDATE-MACRO (339 89 (:REWRITE DEFAULT-+-2))
...
(BITS-EQUIV-CONS-REDUCE (4 4 (:REWRITE DEFAULT-CDR))
...
(ACC-S-RULE)
(ACC-S-RULES)
(INCR (1 1 (:TYPE-PRESCRIPTION INCR)))
(DECR (1 1 (:TYPE-PRESCRIPTION DECR)))
(DECR-INCR-REDUX (6 3 (:TYPE-PRESCRIPTION DECR))
                 (3 3 (:TYPE-PRESCRIPTION INCR)))
(INCR-DECR-REDUX (6 3 (:TYPE-PRESCRIPTION INCR))
...
(MWDMEM)
(INST)
(PREV-INST (1 1 (:TYPE-PRESCRIPTION DECR)))
(IF_ID_SRC1)
(IF_ID_SRC2)
(ID_REGWRITE)
(ID_MEMWRITE)
...
(READDATA)
(STALL)
(PPC+ (5 5 (:TYPE-PRESCRIPTION INCR)))
(PRF+)
(PDMEM+)
(PIMEM+)
(FDWRT+)
(FDINST+)
(FDPC+ (5 5 (:TYPE-PRESCRIPTION DECR)))
(DESRC1+)
(DESRC2+)
(DEARG1+)
(DEARG2+)
...
(MWDMEM+)
(MA)
(PPC-OF-MA-STEP (1 1 (:REWRITE G-DIFF-S)))
(PRF-OF-MA-STEP)
(PDMEM-OF-MA-STEP)
(PIMEM-OF-MA-STEP)
(DEOP-OF-MA-STEP)
...
(I-VAL)
(SIMEM+)
(SPC+ (5 5 (:TYPE-PRESCRIPTION INCR)))
(SRF+)
(SDMEM+)
(ISA)
(SPC-OF-ISA-STEP (1 1 (:REWRITE G-DIFF-S)))
(SRF-OF-ISA-STEP)
(SDMEM-OF-ISA-STEP)
(SIMEM-OF-ISA-STEP)
(FLUSH)
...
(REP)
(COMMIT)
(SPC-OF-REP (1 1 (:REWRITE G-DIFF-S)))
(SRF-OF-REP)
(SDMEM-OF-REP)
(SIMEM-OF-REP)
(EQUAL-REP-ISA (87376 22258 (:REWRITE <<-TRICHOTOMY))
               ...
               (4 4 (:TYPE-PRESCRIPTION ACL2->RCD)))
(EQUAL-REP-REP (87376 22258 (:REWRITE <<-TRICHOTOMY))
               (78426 39149 (:REWRITE DEFAULT-CAR))
               (74352 13016 (:REWRITE <<-ASYMMETRIC))
               (51208 27076 (:REWRITE DEFAULT-CDR))
               (23339 22258 (:REWRITE <<-TRANSITIVE))
