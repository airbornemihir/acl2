(RP::WEAK-RP-EVALUATORS-P)
(RP::CREATE-EVAL-FNC (24 24 (:REWRITE DEFAULT-CAR))
...
(RP::RP-EVL-DISJOIN-ATOM (1 1 (:REWRITE RP::RP-EVL-OF-IF-CALL)))
(RP::RP-EVL-DISJOIN-APPEND (23 23 (:REWRITE RP::RP-EVL-OF-QUOTE))
                           (23 23 (:REWRITE RP::RP-EVL-OF-IF-CALL)))
(RP::RP-EVL-CONJOIN-CONS)
(RP::RP-EVL-CONJOIN-WHEN-CONSP)
(RP::RP-EVL-CONJOIN-ATOM (1 1 (:REWRITE RP::RP-EVL-OF-IF-CALL)))
(RP::RP-EVL-CONJOIN-APPEND (23 23 (:REWRITE RP::RP-EVL-OF-QUOTE))
                           (23 23 (:REWRITE RP::RP-EVL-OF-IF-CALL)))
(RP::RP-EVL-CONJOIN-CLAUSES-CONS (100 50 (:DEFINITION DISJOIN))
...
(RP::RP-EVL-CONJOIN-CLAUSES-ATOM (1 1 (:REWRITE RP::RP-EVL-OF-IF-CALL)))
(RP::RP-EVL-CONJOIN-CLAUSES-APPEND (65 65 (:REWRITE RP::RP-EVL-OF-QUOTE))
                                   (65 65 (:REWRITE RP::RP-EVL-OF-IF-CALL))
                                   (24 12 (:DEFINITION DISJOIN))
                                   (12 12 (:REWRITE RP::RP-EVL-DISJOIN-ATOM))
                                   (12 12 (:DEFINITION DISJOIN2)))
(RP::RP-EVL-THEOREMP-CONJOIN-CONS (53 53 (:REWRITE RP::RP-EVL-CONJOIN-ATOM)))
...
(RP::RP-EVL-META-EXTRACT-FORMULA
     ...
     (8 8
        (:REWRITE RP::RP-EVL-OF-NONSYMBOL-ATOM))
...
(RP::VALID-SC (993 722 (:REWRITE RP::MEASURE-LEMMA1))
              ...
              (34 16 (:REWRITE RP::CONS-COUNT-ATOM))
              (33 33
...
(RP::VALID-RP-META-RULEP)
(RP::VALID-RP-META-RULEP-NECC)
(RP::VALID-RP-META-RULE-LISTP)
(RP::EVAL-AND-ALL-NT (4 1
                        (:REWRITE RP::RP-TERMP-IMPLIES-CDR-LISTP))
                     (3 1 (:DEFINITION ALISTP))
                     (2 2 (:REWRITE DEFAULT-CDR))
                     (2 2 (:REWRITE DEFAULT-CAR)))
