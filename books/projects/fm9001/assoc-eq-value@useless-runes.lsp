...
(FM9001::ASSOC-EQ-VALUE-OF-SI-PAIRLIS$-SIS
     ...
     (270 3 (:DEFINITION STR::ISTRPREFIXP$INLINE))
     (210 3 (:REWRITE STR::IPREFIXP-WHEN-PREFIXP))
     (204 2 (:DEFINITION ASSOC-EQUAL))
     (144 3 (:REWRITE PREFIXP-WHEN-EQUAL-LENGTHS))
     (91 8 (:DEFINITION LEN))
...
(FM9001::ASSOC-EQ-VALUES-SUBSEQ-ARGS-PAIRLIS$-ARGS
     (35193 1731 (:REWRITE TAKE-OF-LEN-FREE))
     (16702 10458 (:REWRITE DEFAULT-+-2))
     (14494 14494 (:LINEAR LEN-WHEN-PREFIXP))
     (8258 7785 (:REWRITE DEFAULT-<-1))
     (7247 7247
           (:LINEAR FM9001::A-HELPFUL-LEMMA-FOR-TREE-INDUCTIONS))
     (1010 388 (:REWRITE CONSP-OF-REPEAT))
     (465 90 (:REWRITE REPEAT-UNDER-IFF))
     (392 98 (:REWRITE LEN-OF-REPEAT))
     (373 373
          (:TYPE-PRESCRIPTION STR::TRUE-LISTP-OF-EXPLODE))
     (335 42
          (:REWRITE FM9001::ASSOC-EQ-VALUE-PAIRLIS$-NOT-MEMBER))
     (268 251 (:REWRITE DEFAULT-UNARY-MINUS))
     (233 233
          (:TYPE-PRESCRIPTION STRINGP-SUBSEQ-TYPE-PRESCRIPTION))
     (213 213
          (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
     (145 90 (:REWRITE STR::CONSP-OF-EXPLODE))
     (116 26
          (:REWRITE FM9001::NOT-MEMBER-TAKE-NTHCDR-LEMMA))
     (116 26
          (:REWRITE FM9001::NOT-MEMBER-NTHCDR-LEMMA))
     (79 6
         (:REWRITE FM9001::ASSOC-EQ-VALUES-TAKE-1))
