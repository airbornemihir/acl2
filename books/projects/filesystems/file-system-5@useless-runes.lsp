...
(L5-WRCHS-CORRECTNESS-1
     ...
     (1709 1709 (:LINEAR POSITION-WHEN-MEMBER))
     (1709 1709
           (:LINEAR POSITION-EQUAL-AC-WHEN-MEMBER))
...
(L5-RDCHS-CORRECTNESS-1
     ...
     (2619 189
           (:REWRITE L5-REGULAR-FILE-ENTRY-P-CORRECTNESS-3
                     . 2))
     (1949 120 (:DEFINITION LEN))
     (1932 1193 (:REWRITE DEFAULT-CDR))
...
(L5-READ-AFTER-WRITE-1
     (120848 157 (:DEFINITION L5-WRCHS))
     (87042 2668
            (:REWRITE INSERT-TEXT-CORRECTNESS-4))
     (74317 29557 (:REWRITE DEFAULT-CDR))
     (68152 1286
            (:REWRITE MAKE-BLOCKS-CORRECTNESS-5 . 1))
     (56576 210 (:DEFINITION SET-INDICES))
     (54333 53 (:DEFINITION L4-WRCHS))
     (53749 24889 (:REWRITE DEFAULT-CAR))
     ...
     (39042 1203
            (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (23122 305 (:DEFINITION TAKE))
     (22590 515 (:DEFINITION NTH))
     (20290 1030 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (18242 210
            (:REWRITE FIND-N-FREE-BLOCKS-CORRECTNESS-2))
     (17250 750 (:DEFINITION L5-TO-L4-FS))
     (17096 277
            (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (17004 9270 (:REWRITE DEFAULT-+-2))
     (16726 277 (:DEFINITION UNMAKE-BLOCKS))
     (16645 2889 (:REWRITE DEFAULT-COERCE-1))
     (16028 610 (:REWRITE TAKE-OF-LEN-FREE))
     (15858 46 (:DEFINITION L3-STAT))
     (15710 3142 (:DEFINITION ASSOC-EQUAL))
     (12727 979 (:REWRITE ASSOC-OF-CAR-WHEN-MEMBER))
     (11732 1032 (:REWRITE L5-FS-P-ASSOC))
     (11732 210
            (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     (11065 7368 (:REWRITE DEFAULT-<-2))
     (10922 28 (:REWRITE CAR-OF-NTHCDR))
     (10857 661 (:DEFINITION CHARACTER-LISTP))
     (10710 210 (:DEFINITION INDICES-MARKED-P))
     (9843 9270 (:REWRITE DEFAULT-+-1))
     (8973 997 (:DEFINITION REMOVE1-ASSOC-EQUAL))
     (8493 2831
           (:TYPE-PRESCRIPTION ASSOC-WHEN-ZP-LEN))
     (8138 7368 (:REWRITE DEFAULT-<-1))
     ...
     (2831 2831 (:TYPE-PRESCRIPTION ZP))
     (2764 76
           (:REWRITE L5-STAT-CORRECTNESS-1-LEMMA-4))
     (2711 2711 (:LINEAR POSITION-WHEN-MEMBER))
     (2711 2711
           (:LINEAR POSITION-EQUAL-AC-WHEN-MEMBER))
...
(L5-READ-AFTER-WRITE-2-LEMMA-5
     ...
     (33611 551
            (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (32940 1830 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (32060 554 (:DEFINITION UNMAKE-BLOCKS))
     (25620 915 (:DEFINITION NTH))
     (23760 1707
            (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (20392 376
            (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     ...
     (4534 4534 (:LINEAR POSITION-WHEN-MEMBER))
     (4534 4534
           (:LINEAR POSITION-EQUAL-AC-WHEN-MEMBER))
...
(L5-READ-AFTER-WRITE-2-LEMMA-8
     ...
     (3650 42
           (:REWRITE FIND-N-FREE-BLOCKS-CORRECTNESS-2))
     (3024 168 (:REWRITE NTH-WHEN->=-N-LEN-L))
     (2982 210
           (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (2562 42
           (:DEFINITION FETCH-BLOCKS-BY-INDICES))
     (2352 84 (:DEFINITION NTH))
     (2348 42
           (:REWRITE L4-WRCHS-CORRECTNESS-1-LEMMA-18))
     (2232 42 (:DEFINITION UNMAKE-BLOCKS))
     (2187 141 (:DEFINITION CHARACTER-LISTP))
     (2142 42 (:DEFINITION INDICES-MARKED-P))
...
(L5-READ-AFTER-WRITE-2
     ...
     (2424 160
           (:REWRITE UNMAKE-BLOCKS-CORRECTNESS-2))
     (2255 63 (:DEFINITION TAKE))
     (1234 63 (:REWRITE CAR-OF-NTHCDR))
     (1209 63 (:REWRITE NTHCDR-WHEN->=-N-LEN-L))
     (1171 63 (:REWRITE NTH-WHEN->=-N-LEN-L))
