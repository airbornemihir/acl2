...
(STRING-INDEX-END)
(NOT-STRING-INDEX-END-CHARACTERP (6 1 (:DEFINITION NTH))
                                 (5 1 (:DEFINITION LEN))
...
(INDEXP)
(INDEXP-CHARACTERP (30 6 (:DEFINITION LEN))
...
(LENGTH-EQUIV-IMPLIES-EQUAL-INDEXP-2 (29 3 (:REWRITE LENGTH-EQUIV-IMPLIES))
...
(BACKREFP)
(BACKREF-INTS)
(LENGTH-EQUIV-IMPLIES-EQUAL-BACKREFP-2 (29 3 (:REWRITE LENGTH-EQUIV-IMPLIES))
                                       (15 1 (:REWRITE IMPLIES-LENGTH-EQUIV))
                                       ...
                                       (4 4 (:LINEAR LENGTH-EQUIV-LINEAR)))
(PSEUDO-BACKREFP)
(BACKREFP-PSEUDO (20 4 (:DEFINITION LEN))
...
(BACKREF-LISTP)
(BACKREF-LISTP-NTH (200 40 (:DEFINITION LEN))
...
(BACKREF-LISTP-NTH-LINEAR (250 50 (:DEFINITION LEN))
...
(PSEUDO-BACKREF-LISTP-NTH (52 52 (:REWRITE DEFAULT-CAR))
...
(BACKREF-LISTP-PSEUDO (100 20 (:DEFINITION LEN))
...
(BACKREF-LISTP-TRUE-LISTP (60 12 (:DEFINITION LEN))
...
(INPUT-LIST-ELTP)
(INPUT-LIST-ELTP-THM)
(INPUT-LIST-ELTP-SUFFIC (60 12 (:DEFINITION LEN))
...
(INPUT-LIST-ELTP-PSEUDO (460 6 (:DEFINITION BACKREF-LISTP))
...
(LENGTH-EQUIV-IMPLIES-EQUAL-INPUT-LISTP-2
     ...
     (114 114
          (:REWRITE INPUT-LISTP-WHEN-SUBSETP-EQUAL))
...
(INPUT-LISTP-PSEUDO
 ...
 (117 117
      (:TYPE-PRESCRIPTION INPUT-LIST-ELTP))
...
(PSEUDO-BACKREF-LISTP-UPDATE-NTH (111 70 (:REWRITE DEFAULT-CAR))
...
(MIN-IDX-IL (1646 18 (:DEFINITION BACKREF-LISTP))
            ...
            (2 2 (:LINEAR LENGTH-EQUIV-LINEAR))
            (1 1 (:LINEAR BACKREF-LISTP-NTH-LINEAR)))
(MIN-IDX-IL-TYPE (200 40 (:DEFINITION LEN))
                 ...
                 (2 2 (:REWRITE BACKREF-INTS)))
(MIN-IDX-IL-LTE-CAR (72 12 (:REWRITE DEFAULT-<-2))
                    (34 10
                        (:REWRITE RATIONALP-IMPLIES-ACL2-NUMBERP))
...
(MIN-IDX-APPEND
     ...
     (464 25
          (:REWRITE PSEUDO-INPUT-LISTP-OF-APPEND))
...
(LONGEST-IL (546 26 (:DEFINITION PSEUDO-BACKREF-LISTP))
...
(LONGEST-IL-TYPE-WEAK (284 96 (:REWRITE INTEGERP-NUMBERP))
...
(REMOVE-ALL-LONGER-EQUAL-IL (3 3 (:REWRITE INPUT-LISTP-PSEUDO))
                            (2 2
                               (:REWRITE PSEUDO-INPUT-LISTP-WHEN-NOT-CONSP))
                            (1 1 (:REWRITE SUBSETP-TRANS2))
                            (1 1 (:REWRITE SUBSETP-TRANS))
