(STR::CHARACTER-LISTP-OF-MAKE-CHARACTER-LIST (17 15 (:REWRITE DEFAULT-CAR))
                                             (12 10 (:REWRITE DEFAULT-CDR)))
(STR::COERCE-INVERSE-BETTER (30 6 (:DEFINITION MAKE-CHARACTER-LIST))
...
(STR::EQUAL-OF-COERCE-STRING (54 6 (:REWRITE COERCE-INVERSE-1))
...
(STR::COERCE-OF-STR-FIX (5 5 (:REWRITE DEFAULT-COERCE-2))
                        (5 5 (:REWRITE DEFAULT-COERCE-1))
                        (1 1 (:REWRITE STR-FIX-DEFAULT)))
(STR::STRRANGE-EQUIV (164 14 (:DEFINITION NTH))
...
(STR::MAKE-CHARACTER-LIST-REDEF (24 24 (:REWRITE DEFAULT-CAR))
...
(STR::STRRANGE-EQUIV-EQUALS-SUBSEQS-EQUAL
     ...
     (212 4
          (:DEFINITION STR::MAKE-CHARACTER-LIST-REDEF))
