...
(SUBSETP-OF-COMPARABLE-MERGESORT
     ...
     (513 12 (:REWRITE ZP-OPEN))
     (348 6 (:REWRITE CONSP-OF-TAKE))
     (336 12 (:REWRITE FLOOR-TYPE-2))
...
(COMPARABLE-MERGESORT-IS-IDENTITY-UNDER-SET-EQUIV-LEMMA-2
     ...
     (32 3 (:REWRITE CDR-OF-APPEND-WHEN-CONSP)))
...
(COMMON-SORT-FOR-PERMS-LEMMA-2
     (3667 979 (:REWRITE COMPARE<-TOTAL-NECC))
     (3024 168 (:DEFINITION COMPARE<-TOTAL))
     (693 170 (:REWRITE CONSP-OF-TAKE))
     (672 672 (:TYPE-PRESCRIPTION COMPARE<-TOTAL))
     (671 395 (:REWRITE DEFAULT-CDR))
     (576 66 (:REWRITE CAR-OF-TAKE))
     (564 120 (:DEFINITION NFIX))
     (536 48 (:REWRITE SECOND-OF-TAKE))
     (459 459
          (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
     (341 138
          (:REWRITE COMPARABLE-ORDEREDP-WHEN-NOT-CONSP))
     (308 287 (:REWRITE DEFAULT-CAR))
     (306 102 (:REWRITE <-+-NEGATIVE-0-1))
     (299 257 (:REWRITE DEFAULT-<-1))
     (296 176
          (:REWRITE COMPARE-TRANSITIVE-IMPLIES))
     ...
     (52 6 (:REWRITE THIRD-OF-TAKE))
     (38 38 (:REWRITE SUBSETP-MEMBER . 4))
     (37 37 (:REWRITE SUBSETP-MEMBER . 2))
     (21 21 (:REWRITE CAR-CONS))
     (6 3 (:REWRITE SUBSETP-OF-CONS))
     (4 4 (:REWRITE DEFAULT-+-2))
     (4 4 (:REWRITE DEFAULT-+-1))
     (2 2 (:DEFINITION ATOM)))
(COMMON-SORT-FOR-PERMS-LEMMA-3
     (548 18 (:DEFINITION MEMBER-EQUAL))
     (444 40
          (:REWRITE COMMON-SORT-FOR-PERMS-LEMMA-1))
     (294 30 (:REWRITE SUBSETP-CAR-MEMBER))
     (243 26 (:REWRITE CONSP-OF-TAKE))
     (209 40 (:REWRITE SUBSETP-MEMBER . 1))
     (202 40
          (:REWRITE COMPARABLE-ORDEREDP-WHEN-NOT-CONSP-OF-CDR))
     (197 116 (:REWRITE DEFAULT-CDR))
     (194 19
          (:REWRITE SUBSETP-IMPLIES-SUBSETP-CDR))
     (124 59 (:REWRITE SUBSETP-WHEN-ATOM-RIGHT))
     (119 119
          (:TYPE-PRESCRIPTION |x < y  =>  0 < -x+y|))
     (101 39
          (:REWRITE COMPARABLE-ORDEREDP-WHEN-NOT-CONSP))
...
(COMMON-SORT-FOR-PERMS-LEMMA-6
     (92 2 (:DEFINITION REMOVE-DUPLICATES-EQUAL))
...
(COMMON-SORT-FOR-PERMS-LEMMA-10
     ...
     (230 5 (:DEFINITION REMOVE-DUPLICATES-EQUAL))
     (159 13
          (:REWRITE COMPARE<-REVERSE-WHEN-STRICT))
...
(COMMON-SORT-FOR-PERMS-LEMMA-11
     ...
     (874 19
          (:DEFINITION REMOVE-DUPLICATES-EQUAL))
     (750 20 (:DEFINITION MEMBER-EQUAL))
...
(COMMON-SORT-FOR-PERMS-LEMMA-14
     ...
     (12880 280
            (:DEFINITION REMOVE-DUPLICATES-EQUAL))
     (5880 280 (:DEFINITION MEMBER-EQUAL))
     (5048 1240
           (:REWRITE COMPARE-TRANSITIVE-IMPLIES))
     (4574 3611 (:REWRITE COMPARE<-TRANSITIVE))
     (4322 2392 (:REWRITE DEFAULT-CDR))
     (4158 162 (:DEFINITION BINARY-APPEND))
     (3920 560 (:REWRITE SUBSETP-CAR-MEMBER))
     (3450 1502 (:REWRITE DEFAULT-CAR))
     (3360 560
           (:REWRITE COMMON-SORT-FOR-PERMS-LEMMA-1))
     (1323 324 (:REWRITE APPEND-WHEN-NOT-CONSP))
     (1188 1114 (:REWRITE DEFAULT-<-1))
     (1123 1114 (:REWRITE DEFAULT-<-2))
...
(COMMON-SORT-FOR-PERMS
     (1886 41
           (:DEFINITION REMOVE-DUPLICATES-EQUAL))
     (861 41 (:DEFINITION MEMBER-EQUAL))
     (574 82 (:REWRITE SUBSETP-CAR-MEMBER))
     (492 82
          (:REWRITE COMMON-SORT-FOR-PERMS-LEMMA-1))
     (279 274 (:REWRITE DEFAULT-CDR))
