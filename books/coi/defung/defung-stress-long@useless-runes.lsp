...
(|iONE-4-MONO-DETERM| (2410 762 (:REWRITE DEFUNG::IF-FN-FALSE))
...
(NOT-ONE-4-0-DOMAIN-IMPLIES-ZERO-ONE-4-0-MEASURE
     (2 1
        (:REWRITE DEFUNG::BOOLEAN-EQUAL-REDUCTION)))
(ONE-4-0-MEASURE-BODY (90 78
                          (:TYPE-PRESCRIPTION DEFUNG::TRUE-FROM-X)))
(ONE-4-0-MEASURE-DEFINITION (1605143 766233 (:REWRITE DEFUNG::IF-FN-FALSE))
                            ...
                            (29522 24687
                                   (:LINEAR ONE-4-0-MEASURE-SMALLEST))
                            (21728 21728 (:DEFINITION FIX)))
(ONE-4-0-DOMAIN-DEFINITION (3576306 1395961 (:REWRITE DEFUNG::IF-FN-FALSE))
...
(ONE-4-0-DEFINITION
     ...
     (196630 196630
             (:REWRITE DEFUNG::NOT-TRUE-FROM-NOT-X))
     (75996 58548
            (:REWRITE |REPLACE-ARB-iONE-4-INDEX-BY-ONE-4-0-MEASURE|))
     (31121 31121 (:REWRITE DEFUNG::TRUE-FROM-X))
     (17348 2924
            (:REWRITE |iONE-4-DOMAIN-MONOTONE|))
     (480 210
          (:REWRITE DEFUNG::BOOLEAN-EQUAL-REDUCTION)))
(ONE-4-0-INDUCTION (12132676 14991 (:DEFINITION ONE-4-0-DEFINITION))
...
(OPEN-ONE-4-0-DOMAIN (61336 74 (:DEFINITION ONE-4-0-DEFINITION))
...
(ONE-4-0-DOMAIN-TRUE (1 1 (:REWRITE OPEN-ONE-4-0-DOMAIN)))
(OPEN-ONE-4-0-BASE)
...
(ONE-4-MEASURE)
(ONE-4-MEASURE-TYPE)
(ONE-4-DEFINITION (279343 88543 (:REWRITE DEFUNG::IF-FN-FALSE))
...
(ONE-4-MEASURE-DEFINITION
     ...
     (107 1
          (:REWRITE DEFUNG::BOOLEAN-EQUAL-REDUCTION)))
(ONE-4-INDUCTION (3118416 1187354 (:REWRITE DEFUNG::IF-FN-FALSE))
...
(OPEN-ONE-4-DOMAIN (15528 5256 (:REWRITE DEFUNG::IF-FN-FALSE))
                   ...
                   (360 360 (:REWRITE DEFUNG::NATP-FIX)))
(ONE-4-DOMAIN-TRUE (1 1 (:REWRITE OPEN-ONE-4-DOMAIN)))
(OPEN-ONE-4-BASE)
(OPEN-ONE-4-INDUCTION
     (160883 27863 (:REWRITE DEFUNG::NORMALIZE-TRUE))
     (144617 59
             (:DEFINITION ONE-4-DOMAIN-DEFINITION))
